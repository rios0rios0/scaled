...
A TypeScript CLI tool (codename "scaled") for orchestrating security scanning tools like Nmap, Nikto, and SQLMap, with support for parsing scan reports and distributing jobs via AWS SQS.
